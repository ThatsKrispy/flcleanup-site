...
(function(){
  ...
  /* Scroll-reveal removed: an IntersectionObserver-gated fade-in
     was found to leave sections permanently invisible at narrow
     viewports when the observer didn't fire before paint. Content
     visibility must never depend on a JS animation hook, so all
     .reveal elements are simply visible via their base CSS rule
     (opacity:1) with no JS involvement. */
